...
<body>
                        ...
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<div class="errorTxt3"></div>
                                        ...
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Voulez-vous confirmer la commande ?');" name="submit"  class="btn btn-success btn-block" value="Commandez maintenant"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
    ...
    <!--angularjs-->
    <script type="text/javascript" src="../Pokebowl/js/plugins/angular.min.js"></script>
    <!--materialize js-->
    ...
    <script type="text/javascript" src="../Pokebowl/js/plugins/jquery-validation/jquery.validate.min.js"></script>
    <script type="text/javascript" src="../Pokebowl/js/plugins/jquery-validation/additional-methods.min.js"></script>	
	<script type="text/javascript" src="../Pokebowl/js/plugins/formatter/jquery.formatter.min.js"></script>   
