...
if(isset($_POST['submit'] )) 
{
     if(empty($_POST['firstname']) || 
		...
		empty($_POST['cpassword']))
		{
			$message = "Tous les champs doivent être obligatoires !";
		}
	else
	{
	...
	{
      echo "<script>alert('Le mot de passe doit être >=6');</script>"; 
	}
    ...
    {
          echo "<script>alert('Adresse e-mail invalide, veuillez saisir un e-mail valide !');</script>"; 
    }
...
<body>
<div style=" background-image: url('images/plats/Pokawa.jpg');">
						...
						if(empty($_SESSION["user_id"]))
							{
							  ...
							  <li class="nav-item"><a href="registration.php" class="nav-link active"><font color="#fab636" class="than">Inscrire </font></a> </li>';
							}
						else
							{
                        ...
                        <div class="widget" >
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="Enregistrer" name="submit" class="btn theme-btn"> </p>
                                    </div>
                                 </div>
                              </form>
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                   <p>1086 Nan'An, Chongqing, China</p>
