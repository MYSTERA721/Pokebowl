...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]', f_name='$_POST[fname]', address='$_POST[address]',l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".md5($_POST[password])."' where u_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Mettre à jour les utilisateurs</h4>
                            </div>
                            <div class="card-body">
										 ...
										 <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control form-control-danger"   value="<?php  echo $newrow['address'];  ?>" placeholder="Adresse">
                                                    </div>
                                                </div>
