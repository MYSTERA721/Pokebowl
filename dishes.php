...
<head>
    ...
    <link rel="icon" href="#">
    <title>Les plats existants</title>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="plats.php?res_id='.$rows['rs_id'].'" class="btn btn-purple">Créer mon propre plats</a>
                                                                        </div>
																</div>
																<!-- end:right info -->
															</div>';
                    ...
                    <div class="food-item white">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div class="rest-descr">
                                    <h6><a href="#">Yorkshire Lamb Patties</a></h6> </div>
