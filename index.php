...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php"><font color="#fab636" class="than">Accueil </font> <span class="sr-only">(current)</span></a> </li>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
                            ...
                            echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active "> Commandes</a> </li>'; 
                            echo  '<li class="nav-item"><a href="information.php?user_upd='.rows['u_id'].'" class="nav-link active "> A propos</a> </li>';
        ...
        <section class="hero bg-image" data-image-src="images/plats/commande.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1><marquee>Commander et  à emporter</marquee> </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choisir Restaurant</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Commande</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Livraison à emporter</h4> </div>
        ...
        <section class="popular">
            <div class="container ">
                <div class="title text-xs-center m-b-30">
                    <h2>Plats populaires du mois</h2>
                    <p class="lead">Le moyen le plus facile de commander votre plat préféré parmi ces 6 plats populaires</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">Rs '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Commander</a> </div>
                                                </div>
        ...
        <section class="how-it-works">
            <div class="container text-center hero-text font-white">
                <div class="text-xs-center">
                    <h2><font color="white">Facile à commander</font></h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p><font color="#d9d9d9">Nous avons ce qu'il vous faut avec des menus provenant d'une variété de restaurants de livraison en ligne.</font></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Nous avons ce qu'il vous faut avec une variété de restaurants de livraison en ligne.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Cueillette ou Livraison</h3>
                                <p>Faites-vous livrer vos plats ! Et bon appétit ! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Paiement à la livraison</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Restaurants en vedette</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <li><a href="#" class="selected" data-filter="*">Tous</a> </li>
									<?php 
