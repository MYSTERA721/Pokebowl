                    ...
                    <div class="col-md-8"> 
                            ...
                            <form>
		                          <h2>Les ingrédients</h2>
		                              <label><input type="checkbox" name="ingredients[]" value="poulet"> Poulet&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ingredients[]" value="boeuf"> Boeuf&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ingredients[]" value="poisson"> Poisson&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ingredients[]" value="avocat"> Avocat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ingredients[]" value="fromage"> Fromage</label>
